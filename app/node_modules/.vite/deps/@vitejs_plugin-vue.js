  ...
  return {
    ...
    config(config) {
      ...
      return {
        ...
        define: {
          __VUE_OPTIONS_API__: (((_b = options.value.features) == null ? void 0 : _b.optionsAPI) || ((_c = config.define) == null ? void 0 : _c.__VUE_OPTIONS_API__)) ?? true,
          __VUE_PROD_DEVTOOLS__: (((_d = options.value.features) == null ? void 0 : _d.prodDevtools) || ((_e = config.define) == null ? void 0 : _e.__VUE_PROD_DEVTOOLS__)) ?? false,
          __VUE_PROD_HYDRATION_MISMATCH_DETAILS__: (((_f = options.value.features) == null ? void 0 : _f.prodHydrationMismatchDetails) || ((_g = config.define) == null ? void 0 : _g.__VUE_PROD_HYDRATION_MISMATCH_DETAILS__)) ?? false
        },
        ssr: {
